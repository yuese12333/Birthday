...
| 3 | 大学时间线 | 拖拽排序 + 触摸点选交换 | 待实现 ⏳ |
| 4 | 表白分支 | 对话逐行 + 选项分支 + 彩蛋 | 待实现 ⏳ |
| 5 | 约会卡牌 | 多关卡卡牌组合 + 协同加成 | 待实现 ⏳ |
| 6 | 织围巾 | 点击 / 拖动连续涂抹 + 进度条 | 待实现 ⏳ |
| 7 | 未来愿望 | 许愿生成星星 + 终章祝福 | 待实现 ⏳ |
